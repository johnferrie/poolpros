  ...
  <div className="page-services page-container">
    ...
    <header className="services__header">
      <picture className="services__picture">
        <source
          srcSet="/images/hero-image-mobile.png"
      ...
      <p className="services__description">
        ...
        maximus eros sit amet molestie. Nullam semper sed odio ac consectetur.
        Sed sapien nisl, pharetra in lacus in, molestie consequat enim. Praesent
    ...
    <div className="services__container">
      ...
      <div className="services__service">
        <h3 className="services__subtitle services__subtitle--2">
          Construction
        </h3>
        <ul className="services__list">
      ...
      <div className="services__service">
        <h3 className="services__subtitle services__subtitle--3">
          Maintenance
        </h3>
        <ul className="services__list">
